...
<head>
    ...
    <title>Kolyeler - Lüks Bijüteri Mağazası</title>
...
<body>
    ...
    <div class="bg-light py-5">
        <div class="container">
            <h1 class="text-center">Kolye Koleksiyonu</h1>
            <p class="text-center text-muted">En özel ve zarif kolye tasarımlarımız</p>
        </div>
    </div>
            ...
            <div class="col-md-9" id="product-list">
                <div class="row">
                    ...
                    if ($sonuc && mysqli_num_rows($sonuc) > 0) {
                        ...
                        echo '<div class="col-12"><p class="text-center">Henüz kolye ürünü bulunmamaktadır.</p></div>';
                    }
                    ?>
                </div>
            </div>
    ...
    <script>
        ...
        $('#material-filter, #price-filter').on('change', function() {
            ...
            $.get('filtre.php', { kategori: 'Kolye', malzeme: malzeme, fiyat: fiyat }, function(data) {
