...
<head>
    ...
    <title>Küpeler - Lüks Bijüteri Mağazası</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="küpe.php">Küpeler</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="bg-light py-5">
        <div class="container">
            <h1 class="text-center">Küpe Koleksiyonu</h1>
            <p class="text-center text-muted">En özel ve zarif küpe tasarımlarımız</p>
        </div>
    </div>
            ...
            <div class="col-md-9" id="product-list">
                <div class="row">
                    ...
                    if ($sonuc && mysqli_num_rows($sonuc) > 0) {
                        ...
                        echo '<div class="col-12"><p class="text-center">Henüz küpe ürünü bulunmamaktadır.</p></div>';
                    }
                    ?>
                </div>
            </div>
    ...
    <script>
        ...
        $('#material-filter, #price-filter').on('change', function() {
            ...
            $.get('filtre.php', { kategori: 'Küpe', malzeme: malzeme, fiyat: fiyat }, function(data) {
